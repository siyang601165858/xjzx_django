...
SECRET_KEY = 'm#w%woj#=6ay_(to6qp*afwc^i*+bmsr+(j6*%&d+39y7cb5do'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/xinjingzixun.log"),  # 日志文件的位置
